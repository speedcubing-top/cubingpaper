...
public class BlockStateList {
    ...
    static class BlockData extends BlockDataAbstract {
        ...
        private com.google.common.collect.Table<IBlockState, Comparable, IBlockData> c;
        // TacoSpigot end
        ...
        private BlockData(Block block, ImmutableMap<IBlockState, Comparable> immutablemap) {
            ...
            if (top.speedcubing.paper.CubingPaperConfig.useArraysForBlockStates) {
                b = new net.techcable.tacospigot.ImmutableArrayMap<>(IBlockState.INDEXER, immutablemap);
            } else {
                b = immutablemap;
            }
            // TacoSpigot end
        ...
        public void a(Map<Map<IBlockState, Comparable>, BlockStateList.BlockData> map) {
            if (this.c != null) {
                ...
                // TacoSpigot start
                if (top.speedcubing.paper.CubingPaperConfig.useArraysForBlockStates) {
                    this.c = new net.techcable.tacospigot.ImmutableArrayTable<IBlockState, Comparable, IBlockData> (
                            IBlockState.INDEXER,
